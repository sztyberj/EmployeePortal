...
from Backend.emailSender import *
from Backend.logPassGenerator import *
...
class LoginMenu:
    ...
    def RememberPassword(self, root, main_frame):
        ...
        entry_email = Entry(main_frame, width=20, borderwidth=1, highlightthickness=0, bg="orange")
        ...
        cancel_button = Button(main_frame, bg="orange", text='Anuluj', highlightthickness=0, width=6, height=1, fg= '#2A2828', activebackground='#840707',
                               command=lambda: Window.combine_funcs(Window.ClearFrame(root), LoginMenu.CreateLoginMenu(self, root, main_frame)))
